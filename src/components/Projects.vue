<template>
    <v-container
        fluid
        :class="!dark ? 'projects-page-light' : 'projects-page-dark'"
    >
        <v-row>
            <v-col>
                <h1
                    :class="
                        !dark ? 'projects-title-light' : 'projects-title-dark'
                    "
                >
                    Projects
                </h1>
        ...
        return {
            allCardInfo: [
                ...
                },
                {
                    title: "Weatherman",
                    description:
                        "Tired of looking at the weather with ads? Here is a dead simple app that ONLY gives you the weather forecast.",
                    imgSrc:
